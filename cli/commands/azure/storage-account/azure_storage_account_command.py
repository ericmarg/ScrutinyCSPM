...
from src.scrutinycspm.utils.azure_credentials import get_azure_credentials

class AzureStorageCommand(CommandPlugin):
    """
    A command plugin for executing Storage Scanning related operations.
    """
    ...
    def __init__(self, region, *args, **kwargs):
        ...
        """
        logging.debug("Initialized Azure Storage Command")
