...
class AwsRdsMySQLScanner:
    ...
    def run_scan(self, private_data_dir="src/scrutinycspm/resources/playbooks"):
        ...
        try:
            ...
            rds_databases = result.get_fact_cache("localhost")
            rds_databases_json = rds_databases["rds_databases_json"]

            return rds_databases_json

        except Exception as e:
            # Handle the exception
            print(f"An error occurred during the RDS MySQL scan: {str(e)}")
            return None
