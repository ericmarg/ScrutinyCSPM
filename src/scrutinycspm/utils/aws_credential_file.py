...
def get_aws_credentials(profile_name: str = "default") -> tuple:
    ...
    if os.path.exists(aws_config_path):
        ...
        if profile_name in config.sections():
            ...
            print(f"No {profile_name} profile found in the AWS configuration file.")
    else:
        print("AWS configuration file not found.")
...
def remove_profile(profile_name, aws_configurations_path="~/.aws/credentials"):
    ...
    if profile_name in config.sections():
        ...
        print(
            f"Profile '{profile_name}' has been removed from the AWS configuration file."
        )
    else:
